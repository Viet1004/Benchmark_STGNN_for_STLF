...
#SBATCH --cpus-per-task=7   # Change accordingly, note that 1 GPU is proivisioned per 7 CPU cores
#SBATCH --gpus-per-task=1
#SBATCH --partition=gpu
#SBATCH --qos=normal
#SBATCH --output=/home/users/qnguyen/Graph/output/#%x_%j.out  # Print messages to 'Jupyter_<job id>.out
#SBATCH --error=/home/users/qnguyen/Graph/output/#%x_%j.err   # Print debug messages to 'Jupyter_<job id>.err
#SBATCH --time=0-2:00:00   # Change maximum allowable jupyter server uptime here
